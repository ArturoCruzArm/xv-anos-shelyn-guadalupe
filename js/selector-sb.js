...
// Slug: xv-sheilyn-guadalupe | Storage key: xv_anos_sheilyn_guadalupe_photo_selections
(function () {
    ...
    var EVENTO_SLUG   = 'xv-sheilyn-guadalupe';
    var SB_KEY        = 'xv_anos_sheilyn_guadalupe_photo_selections';
    ...
    // Includes caja_fotos, caja_usb as extras stored in datos JSONB
    function baseSelection(sel) {
        return {
            ...
            caja_fotos: !!(sel && sel.caja_fotos),
            caja_usb: !!(sel && sel.caja_usb)
        };
    }

    function hasAny(sel) {
        sel = baseSelection(sel);
        return sel.ampliacion || sel.impresion || sel.invitacion || sel.descartada || sel.caja_fotos || sel.caja_usb;
    }
    ...
    function rowToSelection(row) {
        var d = row.datos || {};
        var sel = {
            impresion: !!(d.impresion !== undefined ? d.impresion : row.impresion),
            invitacion: !!(d.invitacion !== undefined ? d.invitacion : row.invitacion),
            descartada: !!(d.descartada !== undefined ? d.descartada : row.descartada),
            ampliacion: !!(d.ampliacion !== undefined ? d.ampliacion : row.ampliacion),
            caja_fotos: !!d.caja_fotos,
            caja_usb: !!d.caja_usb
        };
        return sel;
    }
